...
public class ApprovePostil {
	...
	/**目标评价*/
	private CodeLibrary evaluation;
	/**批复动作*/
	...
	public CodeLibrary getEvaluation() {
		return evaluation;
	}
	public void setEvaluation(CodeLibrary evaluation) {
		this.evaluation = evaluation;
	}
	public Role getApproveRole() {
		return approveRole;
	}
	public void setApproveRole(Role approveRole) {

...
<c:set var="entityName"
	value="com.lxq.platform.goalManage.pojo.DateBatch"></c:set>
...
<script type="text/javascript">
	var params = {
		...
		/**grid 的sql from 语句**/
		gridSql : 'from date_batch',

		/**form 的sql from 语句**/
		formSql : 'from date_batch',

...
<script type="text/javascript">
	var params = {
		...
		/**grid 的sql from 语句**/
		gridSql : 'from basic_group',

		/**form 的sql from 语句**/
		formSql : 'from basic_group',
	...
	var params3 = {
		...
		formFields : [ {
			...
			items : [ {
				...
				items : [ {
					...
					field : 'userUid',
					allowBlank : false,
					codeSql : 'select uid as uid,userName as text from basic_user'
				} ]
			} ]
		} ],
		...
		buttons : [ {
			name : 'add_button',
			visible : ${pt:hasRight(curUser,'add', entityName3)}
		}, {
			name : 'query_button',
			visible : false
		}, {
			...
			name : 'delete_button',
			visible : ${pt:hasRight(curUser,'delete', entityName3)}
		}, {
			name : 'search_button',
			visible : false
		}, {
